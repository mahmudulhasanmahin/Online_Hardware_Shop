            ...
            <div class="section section-basic">
                <div class="container">
                      <h2>       <?php
                                ...
                                ?><?php echo $_SESSION['username']; ?>'s Checking Out!
                      </h2>
                      <hr color="orange">
...
$cart_table = mysqli_query($dbconn,"SELECT sum(total) FROM order_details WHERE user_id='$user_id' AND order_id=''") or die(mysqli_error());
    ...
    $res=mysqli_query($dbconn,"INSERT INTO order_info (user_id, track_num, name, email, shipping_add, order_date, status, totalprice, tax)
    VALUES ($user_id,$track_num,'$name','$email','$ship_add','$date','Pending',$total,$tax)");
